...
export default function Conversations() {
    ...
    return (
        ...
        <div className={`w-80 h-[89vh] md:h-full md:w-auto rounded-2xl p-5 md:flex flex-col ${selectedprofile ? "bg-gray-100" : ""} ${!selectedprofile ? "hidden" : ""}`}>
            {!selectedprofile ? (<Placeholder />) : (<>
                ...
                <div className="h-[8vh] relative bg-gray-100  md:top-12 bottom-5">
